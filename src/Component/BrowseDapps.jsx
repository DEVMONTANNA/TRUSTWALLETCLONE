...
const BrowseDapps = () => {
  return (
   <div className='w-[100%] p-[20px] flex items-center justify-center'>
     ...
     <p className=' text-[1.1rem]  mt-[20px]'> Access Web3 and DeFi opportunities via our dApp browser</p>
     </div>
  ...
  <div className='w-[100%]  lg:w-[50%] lg:p-[20px] p-[3px] flex flex-col  lg:items-start '>
    ...
    <Button
  className="border border-[blue] lg:w-[] w-[100%] hover:bg-[blue] hover:text-[white] cursor-pointer text-black p-2 rounded-[23px]  mt-[20px] justify-center flex items-center gap-3"
